...
if (isset($_GET['index'])) {
    $incomingRaw = rawurldecode(trim((string)$_GET['index']));
...
$title = "{$BRANDS} {$randomEmoji} {$randomWord} เว็บไซต์อย่างเป็นทางการของแพลตฟอร์มการเดิมพันและข่าวสารอันดับ 1 ของประเทศไทย";
$desc  = "{$BRANDS} {$randomWord} เว็บไซต์อย่างเป็นทางการของแพลตฟอร์มการเดิมพันและข่าวสารอันดับ 1 ของประเทศไทย! ค้นพบประสบการณ์การเดิมพันออนไลน์ที่ดีที่สุดกับ {$BRANDS} แพลตฟอร์มที่เชื่อถือได้ซึ่งนำเสนอเกมต่างๆ เช่น บาคาร่า สล็อต และการเดิมพันกีฬา พร้อมการรับประกันความปลอดภัย นอกจากนี้ ยังรับข่าวสารล่าสุดเกี่ยวกับโลกแห่งการเดิมพันและเคล็ดลับกลยุทธ์การชนะจากผู้เชี่ยวชาญ";
